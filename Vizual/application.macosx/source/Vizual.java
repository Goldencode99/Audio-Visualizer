...
public class Graphic_Clock extends PApplet {
...
public void draw() {
  ...
  if (init == false && second() != prevSec) {
    ...
    if (mouseX >= width - 420 && mouseY <= 120 && mousePressed == false) {
      ...
      line(width - 420, 32.5f, width - 415, 32.5f);// 1/8 line
      line(width - 420, 57.5f, width - 415, 57.5f);// 3/8 line
      line(width - 420, 82.5f, width - 415, 82.5f);// 5/8 line
      line(width - 420, 107.5f, width - 415, 107.5f);// 7/8 line
...
public void keyTyped() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "Graphic_Clock" };
    if (passedArgs != null) {
